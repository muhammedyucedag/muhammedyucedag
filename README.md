...
I am knowledgeable in using ASP.NET MVC and have knowledge of CQRS, MediatR, MSSQL, PostgreSQL, Docker, Onion Architecture, SignalR, Entity Framework and LINQ.
...
ASP.NET MVC'yi kullanma konusunda bilgiliyim ve CQRS, MediatR, MSSQL, PostgreSQL, Docker, Onion Architecture, SignalR, Entity Framework ve LINQ bilgisine sahibim.
...
Ich bin mit der Verwendung von ASP.NET MVC vertraut und habe Kenntnisse in CQRS, MediatR, MSSQL, PostgreSQL, Docker, Onion Architecture, SignalR, Entity Framework und LINQ.
...
![Redis]([https://img.shields.io/badge/JWT-black?style=flat&logo=JSON%20web%20tokens](https://img.shields.io/badge/Redis-902626?logo=redis)) 
